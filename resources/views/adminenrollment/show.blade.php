...
<div class="flex flex-col">
    <div class="px-6 py-2 border-b border-light-grey mb-3">
        <div class="font-bold text-xl">Detail Mahasiswa TA</div>
    </div>
    ...
    <div class="flex flex-row pt-2 text-xs pt-1 pb-3 pl-5">
        ...
        <span class="text-gray-900 ml-1">Detail Mahasiswa TA</span>
    </div>
            ...
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <div class="p-3 space-y-5">
                        ...
                        <div class="flex flex-col"> <span class="text-black-200">{{ $enrollment->status }}</span> </div>
                    </div>
