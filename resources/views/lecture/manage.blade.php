...
<div class="flex flex-col">
    <div class="px-6 py-2 border-b border-light-grey mb-3">
        <div class="font-bold text-xl">Ubah Jadwal Bimbingan</div>
    </div>    
        <div class="flex flex-row pt-2 text-xs pt-1 pb-3 pl-5">
            ...
            <span class="text-gray-900 ml-1">Ubah Jadwal Bimbingan</span>
        </div>
