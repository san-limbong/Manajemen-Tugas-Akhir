...
<div class="flex flex-col">
    <div class="px-6 py-2 border-b border-light-grey mb-3">
        <div class="font-bold text-xl">Ajukan Group TA</div>
    </div>
    <div class="flex flex-row pt-2 text-xs pt-1 pb-3 pl-5">
        ...
        <span class="text-gray-900 ml-1">Ajukan Group TA</span>
    </div>
            ...
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <div class="mb-1"> 
                        ...
                        <textarea type="text"
                        name="deskanggota"
                        placeholder="Alasan anda memilih anggota kelompok"
                    ...
                    <div class="mb-1">
                        ...
                        placeholder="Masukkan nama dosen yang anda pilih" 
                        class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600" required>
                    </div>
                    ...
                    <div class="mb-1"> 
                        ...
                        <textarea type="text"
                        name="deskdosen"
                        placeholder="Alasan anda memilih dosen menjadi pembimbing"
                        class="h-24 py-1 px-3 w-full border-2 border-blue-400 rounded focus:outline-none focus:border-blue-600 resize-none" required></textarea> 
                    </div>
