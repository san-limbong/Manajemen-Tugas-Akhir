            ...
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <div class="p-3 space-y-5">
                        ...
                        <div class="flex flex-col"> <span class="text-black-200">{{ $finalization->namakelompok }}</span> </div>
                    </div>
                    ...
                    <form action="{{ route('adminfinalization.update', $finalization->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="mb-1"> 
