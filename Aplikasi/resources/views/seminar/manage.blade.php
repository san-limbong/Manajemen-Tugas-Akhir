...
<div class="flex flex-col">
    <div class="px-6 py-2 border-b border-light-grey mb-3">
        <div class="font-bold text-xl">Ubah Jadwal Seminar</div>
    </div>    
        <div class="flex flex-row pt-2 text-xs pt-1 pb-3 pl-5">
            ...
            <span class="text-gray-900 ml-1">Ubah Jadwal Seminar</span>
        </div>
            ...
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <div class="mt-3 text-right"> 
                        ...
                        <button class="ml-2 h-10 w-32 bg-yellow-600 rounded text-white hover:bg-yellow-700" type="submit">Ubah
                        </button> 
                    </div>
                    </form>
                </div>
