            ...
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <div class="p-3 space-y-5">
                        ...
                        <div class="flex flex-col"> <span class="text-black-200">{{ $topic->namakelompok }}</span> </div>
                    </div>
                    ...
                    <form action="{{ route('admintopic.update', $topic->id) }}" method="POST">
                        @csrf
                        @method('put')
