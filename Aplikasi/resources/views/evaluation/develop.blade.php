...
<div class="flex flex-col">
    <div class="px-6 py-2 border-b border-light-grey mb-3">
        <div class="font-bold text-xl">Tambah Penilaian</div>
    </div>    
        <div class="flex flex-row pt-2 text-xs pt-1 pb-3 pl-5">
            ...
            <span class="text-gray-900 ml-1">Tambah Penilaian</span>
        </div>
            ...
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <div class="mb-1"> 
                        ...
                        <input type="text"
                        name="seminarnilai"
                        placeholder="Masukkan Nilai Seminar"
                    ...
                    <div class="mb-1"> 
                        ...
                        <input type="text"
                        name="seminarstatus"
                        placeholder="Masukkan Status Seminar"
                        class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600"> 
                    </div>
                    ...
                    <div class="mb-1"> 
                        ...
                        <input type="text"
                        name="tanilai"
                        placeholder="Masukkan Nilai Tugas Akhir"
                        class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600"> 
                    </div>
                    ...
                    <div class="mb-1"> 
                        ...
                        <input type="text"
                        name="tastatus"
                        placeholder="Masukkan Status Tugas Akhir"
                        class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600"> 
                    </div>
