...
<div class="flex flex-col">
    <div class="px-6 py-2 border-b border-light-grey mb-3">
        <div class="font-bold text-xl">Ubah Artefak TA</div>
    </div>    
        <div class="flex flex-row pt-2 text-xs pt-1 pb-3 pl-5">
            ...
            <span class="text-gray-900 ml-1">Ubah Artefak TA</span>
        </div>
        ...
        <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
            <div class="md:flex">
                <div class="w-full px-4 py-6 ">
                    ...
                    <form action="{{ route('finalization.update', $finalization->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="mb-1"> 
                        ...
                        <div class="mb-1">
                            <span class="text-sm">Artefak</span>
                                <div class="mb-3 w-96">
                                <input class="form-control h-12 pt-2 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600
                                id="file"
                                name="file"
                                type="file" required>
                                </div>
